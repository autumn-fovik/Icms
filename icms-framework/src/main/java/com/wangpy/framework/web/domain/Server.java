package com.wangpy.framework.web.domain;

import com.wangpy.common.utils.Arith;
 ...
 * @Author: wangpy
 * @Description: 服务器相关信息
 * @Date: Created in 2022/11/4 12:44
 */
public class Server {
    ...
    private void setMemInfo(GlobalMemory memory) {
        mem.setTotal(convertFileSize(memory.getTotal()));
        mem.setUsed(convertFileSize(memory.getTotal() - memory.getAvailable()));
    ...
    private void setJvmInfo() throws UnknownHostException {
        ...
        jvm.setUsed(convertFileSize(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()));
